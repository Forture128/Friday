...
def on_connect(client, unused_user_data, unused_flags, rc):
...
def on_disconnect(client, unused_user_data, rc):
...
def on_publish(unused_client, user_data, mid):
    """Paho callback when a message is sent to the broker."""
    print('on_publish, user_data {}, mid {}'.format(user_data, mid))
...
def on_subscribe(unused_client, unused_user_data, mid, granted_qos):
    print('on_subscribe: mid {}, qos {}'.format(mid, granted_qos))


def on_message(unused_client, unused_user_data, message):
...
def parse_command_line_args():
    ...
    parser.add_argument(
        '--project_id',
        default='friday-267114',
        help='GCP cloud project name')
    parser.add_argument(
        '--registry_id', required=True,
        default='gateway-sdk-registry',
